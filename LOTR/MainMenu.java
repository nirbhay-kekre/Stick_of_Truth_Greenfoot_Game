...
public class MainMenu extends World {
    ...
    public MainMenu() {
        ...
        addObject(legend, getWidth() / 2 - 180, 500);
        MenuItems startMission = new StartMission();
        addObject(startMission, getWidth() / 2 -30 , 400);

        MenuItems howToPlay = new HowToPlay();
        addObject(howToPlay, getWidth() / 2 + 160, 500);
        ...
        ICommand howToPlayCommand = new Command();

        howToPlayCommand.setReciever(new IReceiver() {
            @Override
        ...
        howToPlay.setCommand(howToPlayCommand);
